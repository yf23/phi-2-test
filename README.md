...
cd phi-2-test
git pull
sudo docker run --rm -it --ipc=host --ulimit memlock=-1 --ulimit stack=67108864 --gpus=all -v ~/phi-2-test:/home/phi-2-test --workdir /home/phi-2-test nvcr.io/nvidia/pytorch:23.10-py3 /bin/bash -c "apt update && apt install -y ffmpeg libavcodec-extra && python -m pip install -r requirements.txt && python /home/phi-2-test/whisper-benchmark.py -s whisper-large-v3 -a /home/phi-2-test/15m_gpt-has-entered-the-chat.mp3"
```
